...
All unchanged functionality, licensing, and attribution come from [MeteorDevelopment/meteor-client](https://github.com/MeteorDevelopment/meteor-client).

Note: To any Meteor maintainers, feel free to request a PR or to copy anything from here and apply it upstream.
